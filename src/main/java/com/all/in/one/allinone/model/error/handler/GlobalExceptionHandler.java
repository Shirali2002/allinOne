package com.all.in.one.allinone.model.error.handler;

import com.all.in.one.allinone.model.error.exception.DuplicateUsernameException;
import com.all.in.one.allinone.model.error.exception.EmailProviderException;
import com.all.in.one.allinone.model.error.exception.PasswordsNotMatchedException;
import com.all.in.one.allinone.model.error.exception.UserNotEnabledException;
import com.all.in.one.allinone.model.error.exception.UserNotFoundException;
import com.all.in.one.allinone.model.error.exception.VerificationFailedException;
